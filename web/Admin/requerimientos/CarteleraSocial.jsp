...
<html>
    ...
    <body background="../../Recursos/img/9.png" >
        ...
        <div >
          ...
          <a class="btn btn-success" href="AgregarCarteleraSocial.jsp">Agregar Nueva cartelera</a>
            ...
            <table class="table table-striped">
                ...
                <tr >
                    ...
                    <th scope="row">
                        <a class="btn btn-warning btn-sm" href="ActualizarCarteleraSocial.jsp?cod=<%= rs.getInt("cod")%>">Editar Cartelera</a>
                    </th>                  
                </tr>
