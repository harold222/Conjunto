...
<html>
    ...
    <body>
           <%
            ...
            ps=con.prepareStatement("select * from TrabajadorEmpresaVigilancia where cedula="+id);
            rs=ps.executeQuery();
            while(rs.next()){
        %>
...
<%
    ...
    if(ced!=null && nom!=null && ape!=null && dir!=null && tel!=null && cel!=null){
        ps=con.prepareStatement("update TrabajadorempresaVigilancia set nombre='"+nom+"', apellido='"+ape+"', direcciones='"+dir+"', telefono='"+tel+"', celulares='"+cel+"', Estado='"+estado+"'WHERE Cedula="+ced);
