...
<html>
    ...
    <body>
           <%
            ...
            ps=con.prepareStatement("select * from empresavigilancia where NitEmpresa="+id);
            rs=ps.executeQuery();
            while(rs.next()){
        %>
            <form action="" method="post" class="form-control" >
                ...
                <div class="container col-lg-3">
                    ...
                    <input class="btn btn-warning" name="btnDevolver" value="Volver" onclick=window.location='EmpresaVigilancia.jsp' >
                </div>
              <% }%>
            </form>
    </body>
...
<%
    ...
    if(razon!=null && nit!=null && dir!=null && numero!=null && cel!=null && estado!=null){
        ps=con.prepareStatement("update empresavigilancia set razonSocial='"+razon+"', direccion='"+dir+"', numeroTelefonico='"+numero+"', celular='"+cel+"', EstadoServicio='"+estado+"'WHERE NitEmpresa="+nit);

        ps.executeUpdate();
        response.sendRedirect("EmpresaVigilancia.jsp");
    }
%>