<%-- 
    Document   : header
    Created on : 20-may-2019, 22:30:16
    Author     : HarolD
--%>
    ...
    <body>
        ...
        <nav class="navbar navbar-dark bg-dark">
            ...
            <div class="dropdown-menu text-center">
                ...
                <div class="dropdown-divider"></div>
                <a style="color: blue" href="Evento.jsp" >Eventos</a><br>
                <div class="dropdown-divider"></div>
                <a style="color: blue" href="EnvioCorreo.jsp" >Enviar correo</a><br>
                <div class="dropdown-divider"></div>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu text-center">
                    ...
                    <a style="color: black" href="ActualizarPerfil.jsp?id=<%= sesion.getAttribute("identificacion")%>" class="dropdown-item">Actualizar datos</a>
