<%-- 
    ...
    Esta pagina sera la encargada de poder traer y actualizar cada uno de los datos que tiene el residente
    guardandolos en la base de datos.
--%>
        ...
        %>
            <form action="" method="post" class="form-control" >
                ...
                <div class="container col-lg-3">
                    ...
                    <input class="btn btn-warning" name="btnDevolver" value="Volver" onclick=window.location='../resident.jsp' >
                </div>
              <% }%>
            </form>
    </body>
