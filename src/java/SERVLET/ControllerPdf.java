...
@WebServlet(name = "ControllerPdf", urlPatterns = {"/Admin/requerimientos/ControllerPdf"})
@MultipartConfig(maxFileSize = 16177215)    // upload file's size up to 16MB

public class ControllerPdf extends HttpServlet {

    public static final String lIST_STUDENT = "/Admin/requerimientos/Informes.jsp";
    public static final String INSERT_OR_EDIT = "/Admin/requerimientos/CargarInformes.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int nuevoid = auto.auto_increm("SELECT MAX(codigopdf) FROM Informe;");
        ...
        RequestDispatcher view = request.getRequestDispatcher("/Admin/requerimientos/Informes.jsp");
        view.forward(request, response);
    }
